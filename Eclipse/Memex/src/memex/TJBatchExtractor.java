...
class TJBatchExtractor {
	...
	public static void main(String[] args) throws Exception {
		...
		InputStreamReader inputStreamReader = new InputStreamReader(new FileInputStream(inputFileName), "UTF-8");
		...
		PrintWriter writer = new PrintWriter(outputFileName + ".csv","UTF-8");
		...
		PrintWriter writer2 = new PrintWriter(outputFileName + ".txt","UTF-8");
